...
- unnecessary null checks for properties that are in practice never null (like customer) => ASK when in doubt
...
- [ ] Can we use value objects instead of primitives?
- [ ] Are there any flag arguments that can be split into separate methods?
- [ ] Are there any long parameter lists that can be refactored into objects?
- [ ] Can we use 'var' for local variables to reduce verbosity?
- [ ] Don't use final for arguments
- [ ] No * imports. Specify imports.
- [ ] No unused code
