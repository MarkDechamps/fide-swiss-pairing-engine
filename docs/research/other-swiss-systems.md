...
- The 2026 edits to Dubov and Lim are mostly editorial, apart from Dubov's wider C2 and its reworded upfloater-set ordering (§1.4). **Burstein changed substantively**: its C6 and C7 were rewritten. The Baku rules were generalised so that they no longer assume 1/½/0 scoring.
